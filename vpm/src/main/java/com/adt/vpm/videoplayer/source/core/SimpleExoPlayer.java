...
import com.adt.vpm.videoplayer.source.core.analytics.AnalyticsListener;
...
import com.adt.vpm.videoplayer.source.core.audio.AuxEffectInfo;
import com.adt.vpm.videoplayer.source.core.decoder.DecoderCounters;
import com.adt.vpm.videoplayer.source.core.device.DeviceListener;
...
import com.adt.vpm.videoplayer.source.core.video.VideoDecoderOutputBufferRenderer;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.adt.vpm.videoplayer.source.core.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.adt.vpm.videoplayer.source.core.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.adt.vpm.videoplayer.source.core.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.adt.vpm.videoplayer.source.core.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
    Assertions.checkNotNull(listener);
  ...
  @Override
  public void removeVideoListener(com.adt.vpm.videoplayer.source.core.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
   ...
   * @deprecated Use {@link #addVideoListener(com.adt.vpm.videoplayer.source.core.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.adt.vpm.videoplayer.source.core.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.adt.vpm.videoplayer.source.core.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  public void prepare() {
    ...
    boolean playWhenReady = getPlayWhenReady();
    @AudioFocusManager.PlayerCommand
    int playerCommand = audioFocusManager.updateAudioFocus(playWhenReady, STATE_BUFFERING);
    updatePlayWhenReady(
        playWhenReady, playerCommand, getPlayWhenReadyChangeReason(playWhenReady, playerCommand));
    player.prepare();
  }
  ...
  public void stop(boolean reset) {
    verifyApplicationThread();
    audioFocusManager.updateAudioFocus(getPlayWhenReady(), STATE_IDLE);
    player.stop(reset);
    currentCues = Collections.emptyList();
  }
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.adt.vpm.videoplayer.source.core.video.VideoListener videoListener : videoListeners) {

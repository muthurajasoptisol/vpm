...
public abstract class MappingTrackSelector extends TrackSelector {
  ...
  public static final class MappedTrackInfo {
     ...
     * @param rendererMixedMimeTypeAdaptiveSupports The {@link RendererCapabilities.AdaptiveSupport} for mixed MIME type
     ...
     * @return The {@link RendererCapabilities.FormatSupport}.
     */
    @RendererCapabilities.FormatSupport
    ...
    public int getAdaptiveSupport(
      ...
      for (int i = 0; i < trackCount; i++) {
        @RendererCapabilities.FormatSupport int fixedSupport = getTrackSupport(rendererIndex, groupIndex, i);
   ...
   *     renderer, track group and track (in that order).
   * @param rendererMixedMimeTypeAdaptationSupport The {@link RendererCapabilities.AdaptiveSupport} for mixed MIME type
   *     adaptation for the renderer.
  ...
  private static int findRenderer(
    ...
    @RendererCapabilities.FormatSupport int bestFormatSupportLevel = RendererCapabilities.FORMAT_UNSUPPORTED_TYPE;
    boolean bestRendererIsUnassociated = true;
    for (int rendererIndex = 0; rendererIndex < rendererCapabilities.length; rendererIndex++) {
      RendererCapabilities rendererCapability = rendererCapabilities[rendererIndex];
      @RendererCapabilities.FormatSupport int formatSupportLevel = RendererCapabilities.FORMAT_UNSUPPORTED_TYPE;
   ...
   *
   * @param rendererCapabilities The {@link RendererCapabilities} of the renderers.
   * @return An array containing the {@link RendererCapabilities.AdaptiveSupport} for mixed MIME type adaptation for the
   *     renderer.
  ...
  private static int[] getMixedMimeTypeAdaptationSupports(
    ...
    @RendererCapabilities.AdaptiveSupport int[] mixedMimeTypeAdaptationSupport = new int[rendererCapabilities.length];

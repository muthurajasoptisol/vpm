...
import com.adt.vpm.videoplayer.source.core.DefaultMediaClock.PlaybackParametersListener;
import com.adt.vpm.videoplayer.source.core.Player.DiscontinuityReason;
import com.adt.vpm.videoplayer.source.core.Player.PlayWhenReadyChangeReason;
import com.adt.vpm.videoplayer.source.core.Player.PlaybackSuppressionReason;
import com.adt.vpm.videoplayer.source.core.Player.RepeatMode;
import com.adt.vpm.videoplayer.source.core.analytics.AnalyticsCollector;
import com.adt.vpm.videoplayer.source.core.source.MaskingMediaPeriod;
...
import com.adt.vpm.videoplayer.source.core.util.HandlerWrapper;
...
/* package */ final class ExoPlayerImplInternal
  ...
  private void doSomeWork() throws ExoPlaybackException, IOException {
    ...
    if ((shouldPlayWhenReady() && playbackInfo.playbackState == Player.STATE_READY)
      ...
      maybeScheduleWakeup(operationStartTimeMs, isPlayingOverTcp() ?

 ...
 */
package com.adt.vpm.videoplayer.source.common;
...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link com.adt.vpm.videoplayer.source.common.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link com.adt.vpm.videoplayer.source.common.util.TraceUtil}
   * trace enabled.
   */

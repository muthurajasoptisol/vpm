 ...
 *       #selectTracks(RendererCapabilities[], TrackGroupArray, MediaSource.MediaPeriodId, Timeline)}. This
 ...
 * TrackGroupArray, MediaSource.MediaPeriodId, Timeline)} contains not only {@link TrackSelection}s for each
...
public abstract class TrackSelector {
   ...
   * #selectTracks(RendererCapabilities[], TrackGroupArray, MediaSource.MediaPeriodId, Timeline)} is activated.
   *

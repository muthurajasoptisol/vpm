...
public class DefaultTrackSelector extends MappingTrackSelector {
  ...
  protected TrackSelection.Definition selectOtherTrack(
          int trackType, TrackGroupArray groups, @RendererCapabilities.Capabilities int[][] formatSupport, Parameters params)
      throws ExoPlaybackException {
    @Nullable TrackGroup selectedGroup = null;
   ...
   *
   * @param formatSupport The {@link RendererCapabilities.Capabilities} for each track, indexed by group index and track
   *     index (in that order).
  ...
  private static boolean rendererSupportsTunneling(
          @RendererCapabilities.Capabilities int[][] formatSupport, TrackGroupArray trackGroups, TrackSelection selection) {
    if (selection == null) {
      return false;
    }
  ...
  /**
   * Returns true if the {@link RendererCapabilities.FormatSupport} in the given {@link RendererCapabilities.Capabilities} is {@link
   ...
   * @param allowExceedsCapabilities Whether to return true if {@link RendererCapabilities.FormatSupport} is {@link
   *     RendererCapabilities#FORMAT_EXCEEDS_CAPABILITIES}.
   * @return True if {@link RendererCapabilities.FormatSupport} is {@link RendererCapabilities#FORMAT_HANDLED}, or if
  ...
  protected static boolean isSupported(
    ...
    @RendererCapabilities.FormatSupport int maskedSupport = RendererCapabilities.getFormatSupport(formatSupport);
  ...
  protected static final class AudioTrackScore implements Comparable<AudioTrackScore> {
    ...
    public AudioTrackScore(Format format, Parameters parameters, @RendererCapabilities.Capabilities int formatSupport) {
      this.parameters = parameters;

        ...
        boolean consume(ParsableByteArray payload) throws ParserException {
            ...
            if (q >= 128 && fragmentOffset == 0) {
                ...
                if (length > 0) {
                    ...
                    System.arraycopy(payload.getData(), payload.getPosition(), quantizationTable, 0,
                            length);
            ...
            fragmentedJpegFrame.appendFragment(payload.getData(), payload.getPosition(), payload.bytesLeft());

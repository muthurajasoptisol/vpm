...
public final class Util {
  ...
  public static boolean isRtspUri(Uri uri) {
    String scheme = uri.getScheme();
    return "rtsp".equals(scheme) || "rtsps".equals(scheme);
  }
   ...
   */
  @Nullable
  public static String getAdaptiveMimeType(int contentType, int fileType) {
    switch (contentType) {
      case C.TYPE_DASH:
        return MimeTypes.APPLICATION_MPD;
      case C.TYPE_HLS:
      ...
      case C.TYPE_SS:
        return MimeTypes.APPLICATION_SS;
      case C.TYPE_OTHER:
        return getMimeTypeFromFileType(fileType);
      default:
        return null;
    }
  }

  private static String getMimeTypeFromFileType(int fileType) {
    switch (fileType){
      case FileTypes.MP4:

...
import com.adt.vpm.videoplayer.source.core.source.ads.AdsLoader.AdViewProvider;
import com.adt.vpm.videoplayer.source.core.source.ads.AdsMediaSource;
 ...
 *       com.adt.vpm.videoplayer.source.extractor.DefaultExtractorsFactory} or the {@link
  ...
  private static SparseArray<MediaSourceFactory> loadDelegates(
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.adt.vpm.videoplayer.source.dash.DashMediaSource$Factory")
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName(
                  "com.adt.vpm.videoplayer.source.smoothstreaming.SsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_SS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.adt.vpm.videoplayer.source.hls.HlsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_HLS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
